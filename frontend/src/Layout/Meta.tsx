...
export default function Meta({
  title = `Monolez Web App`,
  description = `Monolez is a serverless engine for executing serverless functions.`,
  image = "https://monolez.vercel.app/thumbnail.png",
  imageAlt = "OG image Monolez Web App",
  canonical = "https://monolez.vercel.app",
}: {
  title?: string;
  description?: string;
  image?: string;
